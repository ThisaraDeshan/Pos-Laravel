...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('/sells/aging', [SellController::class, 'getAging']);
Route::get('/sells/getcreditdays', [SellController::class, 'getCreditdays']);
    
    //Route::get('/agingreport/aging', [AgingreportController::class, 'getAging']);
    ...
    Route::get('/reports/aging-one', [ReportController::class, 'getAgingOne']);
    Route::get('/reports/crdit-report', [ReportController::class, 'creditReport']);
