...
class ReportController extends Controller
{
    ...
    **/
     ...
     */
    public function getAgingOne(Request $request)
    {
        if (! auth()->user()->can('aging_one.view')) {
 ...
 /**
    ...
    public function creditReport(Request $request)
    {
        ...
        return view('report.credit_report')
            ->with(compact('business_locations', 'customers', 'payment_types', 'customer_groups'));
    }
