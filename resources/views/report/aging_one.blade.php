@extends('layouts.app')
@section('title', __( 'lang_v1.aging_report'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang( 'lang_v1.aging_report')
    </h1>
</section>
...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters')])
        ...
        @endif
    @endcomponent
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'lang_v1.aging_report')])
            ...
            <table class="table table-bordered table-striped ajax_view" id="sell_table">
                <thead>
                    <tr>
                        ...
                        <th>@lang('sale.zero_thirty')</th>
                        <th>@lang('sale.thirty_sixty')</th>
                        <th>@lang('sale.sixty_ninety')</th>
                        <th>@lang('sale.onehundred_twenty')</th>
                        <th>@lang('sale.over_onehundredtwenty')</th>
...
$(document).ready( function(){
    ...
    sell_table = $('#sell_table').DataTable({
        ...
        columns: [          
            ...
            { data: 'zero_thirty', name: 'zero_thirty'},
            { data: 'thirty_sixty', name: 'thirty_sixty'}, 
            { data: 'sixty_ninety', name: 'sixty_ninety'},
            { data: 'onehundred_twenty', name: 'onehundred_twenty'},
            { data: 'over_onehundredtwenty', name: 'over_onehundredtwenty'},
